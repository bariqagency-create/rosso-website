...
export const STATUSES = ['new', 'confirmed', 'in_progress', 'waiting_parts', 'ready', 'delivered', 'cancelled'];
// Legacy values still tolerated when reading old rows.
export const LEGACY_STATUSES = ['pending', 'completed'];
