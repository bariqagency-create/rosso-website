...
export function formatInvoiceWhatsApp(booking, usedParts, isAr = false) {
...
export function getInvoiceWhatsAppLink(booking, usedParts) {
  ...
  const msg = encodeURIComponent(formatInvoiceWhatsApp(booking, usedParts, booking?.lang === 'ar'));
